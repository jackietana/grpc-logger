...
const (
	LoggerService_Log_FullMethodName = "/audit.LoggerService/Log"
)
...
func (c *loggerServiceClient) Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*Empty, error) {
...
func (UnimplementedLoggerServiceServer) Log(context.Context, *LogRequest) (*Empty, error) {
...
var LoggerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "audit.LoggerService",

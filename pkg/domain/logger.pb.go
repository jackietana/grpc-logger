...
func (LogRequest_Actions) EnumDescriptor() ([]byte, []int) {
	return file_proto_logger_proto_rawDescGZIP(), []int{0, 0}
}
...
func (LogRequest_Entities) EnumDescriptor() ([]byte, []int) {
	return file_proto_logger_proto_rawDescGZIP(), []int{0, 1}
}
...
const file_proto_logger_proto_rawDesc = "" +
	"\n" +
	"\x12proto/logger.proto\x12\x05audit\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbb\x02\n" +
	"\n" +
	"LogRequest\x121\n" +
	"\x06action\x18\x01 \x01(\x0e2\x19.audit.LogRequest.ActionsR\x06action\x122\n" +
	"\x06entity\x18\x02 \x01(\x0e2\x1a.audit.LogRequest.EntitiesR\x06entity\x12\x1b\n" +
	"\tentity_id\x18\x03 \x01(\x03R\bentityId\x128\n" +
	...
	"\x05Empty29\n" +
	"\rLoggerService\x12(\n" +
	"\x03Log\x12\x11.audit.LogRequest\x1a\f.audit.Empty\"\x00B\x14Z\x12/pkg/domain/loggerb\x06proto3"
...
var file_proto_logger_proto_depIdxs = []int32{
	...
	2, // 3: audit.LoggerService.Log:input_type -> audit.LogRequest
	3, // 4: audit.LoggerService.Log:output_type -> audit.Empty
